...
Internet _$InternetFromJson(Map<String, dynamic> json) => Internet(
      ...
      promotional_data_lte: json['promotional_data_lte'] as num? ?? 0,
    );
...
Map<String, dynamic> _$InternetToJson(Internet instance) => <String, dynamic>{
      ...
      'promotional_data_lte': instance.promotional_data_lte,
    };
